...
def login():
    username = "esammiya"
    password = "esammiya123"
    if username_entry.get()==username and password_entry.get()==password:
        messagebox.showinfo(title="Login Success", message="You successfully logged in")
    else:
        messagebox.showerror(title="Incoorect", message="Invalid password")

frame = tkinter.Frame(bg='#333333')

login_label = tkinter.Label(frame, text = "Login", bg='#333333', fg = '#FFFFFF', font = ("Arial",30), pady=40)
